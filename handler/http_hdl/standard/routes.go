...
import (
	...
	"github.com/SENERGY-Platform/mgw-host-manager/handler/http_hdl/shared"
	_ "github.com/SENERGY-Platform/mgw-host-manager/handler/http_hdl/swagger_docs"
...
var routes = gin_mw.Routes[lib.Api]{
	GetNetItfBlacklistH,
	PostNetItfBlacklistValueH,
	DeleteNetItfBlacklistValueH,
	GetNetRngBlacklistH,
	PostNetRngBlacklistValueH,
	DeleteNetRngBlacklistValueH,
	GetHostApplicationsH,
	PostHostApplicationH,
	DeleteHostApplicationH,
}
